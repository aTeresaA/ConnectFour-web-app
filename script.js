// connect four after tutorial by Ania Kubów
document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkBoard() {
        for (let y = 0; y < winningArrays.length; y++) {
            ...
            // check those squares to see if they all got the class of player-one
            if (
            ...
            // check those squares to see if they all got the class of player-two
            if (
    ...
    for (let i = 0; i < squares.length; i++){
        ...
        squares[i].onclick = () => {
            //alert('You have clicked square ' + i) // great tip to see if it works
